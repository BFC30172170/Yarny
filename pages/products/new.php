        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
            ...
            <div class="flex flex-col-reverse">
                <div class="w-full aspect-w-1 aspect-h-1">
                    <img id="image-preview" src="/placeholder.png" alt="Angled front view with bag zipped and handles upright." class="w-full h-full object-center object-cover sm:rounded-lg border border-gray-600 mb-6">
            ...
            <div class="flex flex-col">
                <div class="flex items-center">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 w-full">Name
                        <input type="text" name="name" value="name field" class="block w-full text-xl p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500" />
                    </label>
                ...
                <input type="text" name="slug" value="slug field" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />

                <label for="price">Price</label>
                <input type="text" name="price" value="0.99" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />

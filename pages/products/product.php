    ...
    <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        ?>
                ...
                <div class="mt-10 flex sm:flex-col1 gap-4">
                    <button type="submit"
                        class="max-w-xs flex-1 bg-teal-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-teal-500 sm:w-full">Checkout
                        Now</button>
                    <button onclick="addToBasket(<?=$product->id?>)" type="submit"
                        class="max-w-xs flex-1 border border-teal-600 border-4 rounded-md py-3 px-8 flex items-center justify-center text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-teal-500 sm:w-full">Add
                        to bag</button>

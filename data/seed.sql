-- DATABASE CONFIGURATION & SEED DATA, TO CREATE A DATABASE SCHEMA,
-- ADD AN ADMIN USER, ADD SCHEMA OBJECTS AND FINALLY POPULATE WITH SEED DATA,
-- CHANGES TO DATABASE SCHEMA SHOULD BE RESOLVED WITHIN THIS FILE, TO ENSURE LOCAL DEVELOPMENT CAN BE EASILY SETUP
...
CREATE TABLE Message(
    ...
    MESSAGE_DESCRIPTION varchar(40) NOT NULL,
    MESSAGE_CREATED datetime NULL,
    ACCOUNT_ID int NOT NULL,
...
INSERT INTO Account(ACCOUNT_NAME,ACCOUNT_HASHEDPASS,ACCOUNT_ROLE,ACCOUNT_EMAIL,ACCOUNT_TELEPHONE,ACCOUNT_MOBILE) VALUES('admin','$2y$10$LzESCv9NyvnVrBsmSbaKCuw9sZCTDCGvXMbEweSb/oTHxElseq/ky','admin','test@testing.org','0123345324','013819242');

INSERT INTO Account(ACCOUNT_NAME,ACCOUNT_HASHEDPASS,ACCOUNT_ROLE,ACCOUNT_EMAIL,ACCOUNT_TELEPHONE,ACCOUNT_MOBILE) VALUES('user','$2y$10$LzESCv9NyvnVrBsmSbaKCuw9sZCTDCGvXMbEweSb/oTHxElseq/ky','user','user@testing.org','0123345324','013819242');
...
INSERT INTO Address(ADDRESS_FORENAME,ADDRESS_SURNAME,ADDRESS_LINE_1,ADDRESS_POSTCODE,ADDRESS_COUNTRY,ACCOUNT_ID) VALUES('Tess','Ting','10 Test Road','MK18 4RP','United Kingdom',2);

INSERT INTO Sale(SALE_STATUS,ACCOUNT_ID,ADDRESS_ID) VALUES ('created',2,2);
